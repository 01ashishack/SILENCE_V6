...
url = "https://kndeshxeerldamafweru.supabase.co/rest/v1/draft_members?limit=1"
headers = {
...
try:
    print("Checking draft_members table...")
    with urllib.request.urlopen(req) as response:
        html = response.read().decode('utf-8')
        data = json.loads(html)
        print("Success! Table exists. Rows:", len(data))
except Exception as e:
    print(f"Error checking draft_members: {e}")
