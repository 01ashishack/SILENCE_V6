              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.inter(fontSize: 12.5, color: context.palette.textSecondary, height: 1.5),
                  ),
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '1. Eligibility & accounts'),
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '2. License'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '3. Payments'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '4. Acceptable use'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '5. Data & privacy'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '6. Availability & liability'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '7. Termination'),
                  _buildSectionBody(context, 
                  ...
                  const SizedBox(height: 16),
                  _buildSectionHeader(context, '8. Changes & governing law'),
                  _buildSectionBody(context, 
